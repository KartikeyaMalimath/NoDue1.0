	...
	<div class="container-fluid">
            ...
            <nav class="navbar navbar-inverse" style="padding: 0; width: 100%">
                <ul class="nav navbar-nav">
                  <li style="padding-left: 30px;"><a href=<?php $depti = $_SESSION['department']; echo 'Tapindex.php?dept='.$depti; ?>>Back</a></li>
...
<script type="text/javascript">
	function due(clicked_id) {
			window.location.href = ("updtRcrd/dueTap.php?usn="+clicked_id);
			
	}
	function nodue(clicked_id) {
			window.location.href = ("updtRcrd/nodueTap.php?usn="+clicked_id);
