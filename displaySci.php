	...
	<div class="container-fluid">
		...
		<div class="jumbotron">
    		...
    		<?php
                ...
                $depat = $_GET['dept'];
                $_SESSION['depat'] = $depat;

				$sqql = "SELECT * from $depat where Sem = $sem";
...
<script type="text/javascript">
	function due(clicked_id) {
			window.location.href = ("updtRcrd/dueSci.php?usn="+clicked_id);
			
	}
	function nodue(clicked_id) {
			window.location.href = ("updtRcrd/nodueSci.php?usn="+clicked_id);
