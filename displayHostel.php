	...
	<div class="container-fluid">
            ...
            <nav class="navbar navbar-inverse" style="padding: 0; width: 100%">
                <ul class="nav navbar-nav">
                  <li style="padding-left: 30px;"><a href=<?php $depti = $_SESSION['department']; echo 'Hostelindex.php?dept='.$depti; ?>>Back</a></li>
		...
		<div class="jumbotron">
    		...
    		<?php
                ...
                $sex = $_SESSION['sex'];
				$sqql = "SELECT * from hostel where Sem = '$sem' And Sex = '$sex'";
...
<script type="text/javascript">
	function due(clicked_id) {
			window.location.href = ("updtRcrd/duehostel.php?usn="+clicked_id);
			
	}
	function nodue(clicked_id) {
			window.location.href = ("updtRcrd/noduehostel.php?usn="+clicked_id);
